...
DEAD_PIC = ALIVE_PIC if ALIVE_PIC else "https://te.legra.ph/file/4f0335152fd7520a90799.jpg"
  

DEADLY = "✯ KING HACKER SPAM BOT ✯\n\n"
DEADLY += f"═══════════════════\n"
...
async def alive(event):
  if event.sender_id in SUDO_USERS:
     await BOT0.send_file(event.chat_id,
                                  ...
                                  buttons=[
        [
        Button.url("ᴄʜᴀɴɴᴇʟ", "https://t.me/KingHacker_spambot"),
